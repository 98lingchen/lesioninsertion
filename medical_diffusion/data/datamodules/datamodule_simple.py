...
# ---------------- SimpleDataModule Definition ----------------
# A custom PyTorch Lightning DataModule to manage training, validation, and testing datasets.
class SimpleDataModule(pl.LightningDataModule):
    ...
    def __init__(self,
        ...
        # Initialize the DataModule with dataset and training parameters.
        super().__init__()
    ...
    def train_dataloader(self):
        ...
        generator.manual_seed(self.seed)  # Set the seed for reproducibility
